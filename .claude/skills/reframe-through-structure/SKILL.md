...
catalogue:
`mcp__lat__search_patterns { "attachment": "subject", "forced_choice": "whether the participant is the one acting" }`.
...
`mcp__lat__search_patterns { …, "exclude_contested": true }`; reach for a
